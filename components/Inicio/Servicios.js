        ...
        <>
            ...
            <div className="flex col">
                <div className="PADRE md:flex md:row md:justify-around grow mt-8">
                    {serviciosen.map(s => (
                        <div key={s.id} lang="en" className="max-w-sm  rounded-lg border  shadow-md bg-amber-800 border-amber-700 mt-4 ml-2">
                            <a href="#">
                            ...
                            <div className="p-5">
                                ...
                                <a href="#" className="inline-flex items-center py-2 px-3 text-normal font-bold text-center text-amber-800 hover:text-white  rounded-lg  focus:ring-4 focus:outline-none  bg-white hover:bg-amber-600 focus:ring-amber-600">
                                    {s.boton}
                ...
                <div className="PADRE md:flex md:row md:justify-around grow mt-8">
                    ...
                    {serviciosen2.map(s => (
                        <div key={s.id} lang="en" className="max-w-sm  rounded-lg border  shadow-md bg-amber-800 border-amber-700 mt-4 ml-2 mr-2">
                            <a href="#">
                                <Image width={380} height={240} className="rounded-t-lg" src={s.foto} alt="foto" />
                                {/* <img className="rounded-t-lg" src={s.foto} style={{ height: '240px', width: '380px' }} alt="foto" /> */}
                            </a>
