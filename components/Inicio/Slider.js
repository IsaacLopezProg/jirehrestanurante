...
// IMG
import comida from "/public/img/slider/comida.webp";
import jugo from "/public/img/slider/jugo.webp";
import restaurante from "/public/img/slider/restaurante.webp";
                        ...
                        (
                            ...
                            cares.map(c => (
                                <SwiperSlide className="IGLESIA  w-full bg-black">
                                    <div lang="es" className="md:flex relative w-full  " style={{ height: '600px' }}>
                                        <Image src={c.foto}
                                            alt='foto1'
                                            quality={100}
                                            layout='fill'
