...
export default function Cheff({ cheffs }) {
    console.log(cheffs);
    // const { idioma } = props;
    ...
    //         const res = await fetch(`${url}/cheff`)
    //         const cheffs = await res.json()
    //         console.log(cheffs);
    ...
    // const [cheff, setCheff] = useState(undefined);
    // console.log(cheffs);
            ...
            <div class="p-4 mt-16">
                <div class="flex items-center space-y-24 md:space-y-0 flex-col md:flex-row justify-evenly">
                            ...
                            <div class="text-center">
                                ...
                                {/* {idioma === 'es' ?
                                    ...
                                    <p class="text-base md:text-lg  w-60 text-gray-200 mx-auto py-4 font-light">
                                        Specialist in Hispanic, Creole, Venezuelan and Spanish food.
                                    </p>
                                } */}
                                <p class="text-base md:text-lg  w-60 text-gray-200 mx-auto py-4 font-light">
                                    Specialist in Hispanic, Creole, Venezuelan and Spanish food.
                    ...
                    {/* <div class="p-4 relative">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                            <a href="#" class="block relative">
                                <img alt="profil" src="/img/acerca/hombre2.jpg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800" />
                            </a>
                        </div>
                    ...
                    <div class="p-4 relative">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                            <a href="#" class="block relative">
                                <img alt="profil" src="/img/acerca/mujer1.jpg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800" />
                            </a>
                        </div>
                        <div class="bg-amber-800 rounded-lg shadow px-8 py-4 pt-24">
                            <div class="text-center">
                    ...
                    <div class="p-4 relative">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                            <a href="#" class="block relative">
                                <img alt="profil" src="/img/acerca/mujer3.jpg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800" />
                            </a>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
                            <div class="text-center">
